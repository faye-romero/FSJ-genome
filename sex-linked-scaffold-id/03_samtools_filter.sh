...
## PART 3 SLURM script for finding sex-linked scaffolds given a female reference genome and one set of high-coverage paired-end Illumina data.##
...
echo "samtools view -b -f 0x2 -F 260 -q 20 -@ 4 -o ${sam_out_dir}/${NAME}_aln_sorted_temp.bam ${wd}/bwa_out/${NAME}.bam"

samtools view -b -f 0x2 -F 260 -q 20 -@ 4 -o ${sam_out_dir}/${NAME}_aln_sorted_temp.bam ${wd}/bwa_out/${NAME}.bam
chgrp nchen11_lab ${sam_out_dir}/${NAME}_aln_sorted_temp.bam
...
chgrp nchen11_lab ${sam_out_dir}/${NAME}_aln_sorted_filt.bam
...
echo "rm -rf ${sam_out_dir}/${NAME}_aln_sorted_temp.bam"
rm -rf ${sam_out_dir}/${NAME}_aln_sorted_temp.bam
