...
## PART 1 SLURM script for finding sex-linked scaffolds given a female reference genome and a batch of high-coverage paired-end Illumina data from multiple individuals.##
## Faye Romero. University of Rochester. #
## 13 Feb 2024 ##

# To run this script, run its wrapper: sh bash_wrapper_trimgalore.sh
