...
## PART 4 SLURM script for finding sex-linked scaffolds given a female reference genome and a batch of high-coverage paired-end Illumina data from multiple individuals. ##
## Faye Romero. University of Rochester. #
## 29 Nov 2023 ##

# To run this script, run its wrapper: sh bash_wrapper_sambamba.sh
