...
REF='Taegut_short_Chronly.fasta'
QUERY='AphCoe_V3_internal_Mar2024_ChrandSex.fasta'
PREFIX='TaeGutV2_AphCoe'
...
# Create karyogram
#Ref has 41 scaffolds. 360/41 = 8.7. Therefore, set h+= to 9.
