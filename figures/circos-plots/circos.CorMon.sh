...
REF='bCorMon1.pri_genomic_clean_Chronly.fasta'
QUERY='AphCoe_V3_internal_Mar2024_Chronly.fasta'
PREFIX='CorMon_AphCoe'
...
# Create karyogram
#Ref has 36 scaffolds. 360/36 = 10. Therefore, set h+= to 10.
awk '{hue=sprintf("%03d", h); print "chr - "$1" "$1" 0 "$2" hue"hue; h+=10;}' ${REF}.fai >  ${PREFIX}.chr.kar
