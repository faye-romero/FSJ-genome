...
REF='/scratch/nchen11_lab/Faye/new_FSJgenome/autosomes_ORDERED/Gallus_autosomes_ORDERED.fasta'
QUERY='/scratch/nchen11_lab/Faye/new_FSJgenome/autosomes_ORDERED/FSJ_autosomes_ORDERED.fasta'
PREFIX='Gallus_AphCoe_autosomes'
...
# Create karyogram
#Ref has 30 scaffolds. 360/28 = 12.8. Therefore, set h+= to 13.
awk '{hue=sprintf("%03d", h); print "chr - "$1" "$1" 0 "$2" hue"hue; h+=13;}' ${REF}.fai >  ${PREFIX}.chr.kar
