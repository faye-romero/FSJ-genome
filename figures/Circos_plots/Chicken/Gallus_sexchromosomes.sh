#!/bin/bash
#SBATCH -p rosalind
#SBATCH --job-name="circos.Gallus"
#SBATCH -N 1
#SBATCH -c 3
#SBATCH --nodelist=bhd0056
#SBATCH --mem=30G
#SBATCH --time=3-00:00:00
#SBATCH --output=circos.Gallus.log
...
REF='/scratch/nchen11_lab/Faye/new_FSJgenome/sexchromosomes_ORDERED/Gallus_sexchromosomes_ORDERED.fasta'
QUERY='/scratch/nchen11_lab/Faye/new_FSJgenome/sexchromosomes_ORDERED/FSJ_sexchromosomes_ORDERED.fasta'
PREFIX='Gallus_AphCoe_sexchromosomes'
