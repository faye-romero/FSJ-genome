...
REF='/scratch/nchen11_lab/Faye/new_FSJgenome/sexchromosomes_ORDERED/AphCal_sexchromosomes_ORDERED.fasta'
QUERY='/scratch/nchen11_lab/Faye/new_FSJgenome/sexchromosomes_ORDERED/FSJ_sexchromosomes_ORDERED.fasta'
PREFIX='AphCal_AphCoe_sexchromosomes'
...
<links>
<link>
file                = ${PREFIX}.600kb.newlinks.tsv
thickness           = 40p
radius              = 0.95r
ribbon              = yes
flat		    	= yes
