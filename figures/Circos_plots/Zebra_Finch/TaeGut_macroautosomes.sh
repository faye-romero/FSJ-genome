...
REF='/scratch/nchen11_lab/Faye/new_FSJgenome/autosomes_ORDERED/TaeGut_macroautosomes_ORDERED.fasta'
QUERY='/scratch/nchen11_lab/Faye/new_FSJgenome/autosomes_ORDERED/FSJ_macroautosomes_ORDERED.fasta'
PREFIX='TaeGut_AphCoe_macroautosomes'
...
# Create karyogram
#Ref has 11 scaffolds. 360/11 = 32.7. Therefore, set h+= to 33.
awk '{hue=sprintf("%03d", h); print "chr - "$1" "$1" 0 "$2" hue"hue; h+=33;}' ${REF}.fai >  ${PREFIX}.chr.kar
