#!/bin/bash
#SBATCH -p rosalind
#SBATCH --job-name="circos.CorMon"
#SBATCH -N 1
#SBATCH -c 3
#SBATCH --nodelist=bhd0056
#SBATCH --mem=30G
#SBATCH --time=3-00:00:00
#SBATCH --output=circos.CorMon.log
...
REF='/scratch/nchen11_lab/Faye/new_FSJgenome/sexchromosomes_ORDERED/CorMon_sexchromosomes_ORDERED.fasta'
QUERY='/scratch/nchen11_lab/Faye/new_FSJgenome/sexchromosomes_ORDERED/FSJ_sexchromosomes_ORDERED.fasta'
PREFIX='CorMon_AphCoe_sexchromosomes'
...
# Create karyogram
#Ref has 2 scaffolds. 360/2 = 180. Therefore, set h+= to 180.
awk '{hue=sprintf("%03d", h); print "chr - "$1" "$1" 0 "$2" hue"hue; h+=180;}' ${REF}.fai >  ${PREFIX}.chr.kar
...
<links>
<link>
file                = ${PREFIX}.100kb.newlinks.tsv
thickness           = 40p
radius              = 0.95r
ribbon              = yes
flat		    	= yes
