...
REF='/scratch/nchen11_lab/Faye/new_FSJgenome/autosomes_ORDERED/CorMon_autosomes_ORDERED.fasta'
QUERY='/scratch/nchen11_lab/Faye/new_FSJgenome/autosomes_ORDERED/FSJ_autosomes_ORDERED.fasta'
PREFIX='CorMon_AphCoe_autosomes'
...
# Create karyogram
#Ref has 30 scaffolds. 360/30 = 12. Therefore, set h+= to 12.
